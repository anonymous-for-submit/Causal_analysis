...
class OpenAILLM(BaseLLM):
    ...
    def _make_client_kwargs(self,model='gpt') -> dict:
        ...
        if 'gpt' in model:
            # key='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'
            key='sk-FRQxdGxCMDSPoogN0SgdGGm4IEfv3uMjUFTtgepRNC7bnxO8'
